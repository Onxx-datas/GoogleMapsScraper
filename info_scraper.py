...
from settings import API_KEY, LOCATIONS, RADIUS, KEYWORD, MAX_RESULTS  

# List to store hospital information temporarily
hospitals = []

def get_phone_number(place_id):
    """
    Function to get the phone number of a place using its place_id.
    This function sends a request to the Google Places API details endpoint.
    """
